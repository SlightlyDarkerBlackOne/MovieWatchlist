...
public static class TestConstants
{
    ...
    public static class Tmdb
    {
        ...
        public const string InvalidGenre = "InvalidGenre";
        public const string InvalidGenreErrorMessage = "Invalid genre";
    }
    ...
    // Test Database Seeder Counts
    public static class SeederCounts
    {
        public const int Users = 3;
        public const int Movies = 5;
        public const int WatchlistItems = 6;
        public const int RefreshTokens = 4;
        public const int ActiveUsers = 2;
        public const int PlannedWatchlistItems = 2;
        public const int WatchedWatchlistItems = 3;
        public const int WatchingWatchlistItems = 1;
        public const int FavoriteWatchlistItems = 3;
        public const int RatedWatchlistItems = 3;
        public const int UnratedWatchlistItems = 3;
        public const int FirstUserWatchlistItems = 4;
        public const int ValidRefreshTokens = 2;
        public const int ExpiredRefreshTokens = 1;
        public const int RevokedRefreshTokens = 1;
    }
